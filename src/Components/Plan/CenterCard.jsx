...
function CenterCard() {
  return (
    <div className='h-[600px] shadow-xl bg-white z-20 xl:mt-[-50px]  mt[-30px] w-[374px] py-[10px] drop-shadow-2xl rounded-[20px]'>
        {/* header */}
        ...
        <p className="text-[30px] font-semibold  text-[#333333]">
            ...
            Experiment the power of infinite possibilities            </p>
            ...
            <div className='bg-[#f9f9fa] px-2  rounded-[10px]'>
            <p className="px-4 text-center text-[#3585FF] font-semibold">
            Save $50 a year</p>
            </div>
        </div>
    {/* list */}
